            ...
            <>
                <Header transparent style={{ backgroundColor: 'white' }}>
                    <Left>
                        ...
                        <Title style={{ position: 'absolute', color: 'black', marginLeft: 30, marginTop: 10, fontWeight: 'bold' }}></Title>
                    </Left>
                    <Body >
                ...
                <Container style={{ backgroundColor: '#f0f0f0' }}>
                    <ScrollView>
                        <Form style={{ marginBottom: 10 }}>
                            ...
                            >
                                <Text style={{ color: 'white', fontSize: 18, fontWeight: '700' }}>Let's View All</Text>
                            </Button>
                        </Form>
